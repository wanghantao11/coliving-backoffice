...
const offer_1 = require("../../../../src/infrastructure/utils/offer");
const entity_1 = require("../../../../src/domain/entity");
describe('testing the offer function filterByAccessability()', () => {
    it('should filter out rooms unqualified', () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        const rooms = [room];
        const res = offer_1.filterByAccessability({ is_suitable_for_disability })(rooms);
...
describe('testing the offer function filterByRoomType()', () => {
    it('should filter out rooms unqualified', () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        const rooms = [room];
        const res = offer_1.filterByRoomType(roomPreferences)(rooms);
        expect(res.length).toBe(1);
    }));
    it('should filter out rooms unqualified', () => __awaiter(void 0, void 0, void 0, function* () {
...
describe('testing the offer function filterByFacility()', () => {
    it('should filter out rooms unqualified', () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        const rooms = [room];
        const res = offer_1.filterByFacility(roomPreferences)(rooms);
        expect(res.length).toBe(0);
    }));
    it('should filter out rooms unqualified', () => __awaiter(void 0, void 0, void 0, function* () {
        const roomPreferences = { has_private_toilet: true, has_private_bathroom: false };
...
describe('testing the offer function filterByPrice()', () => {
    it('should filter out rooms unqualified', () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        const rooms = [room];
        const res = offer_1.filterByPrice({ rent_to })(rooms);
        expect(res.length).toBe(1);
    }));
    it('should filter out rooms unqualified', () => __awaiter(void 0, void 0, void 0, function* () {
        const rent_to = 1990;
...
describe('testing the offer function pickNonIdenticalRooms()', () => {
    it('should pick non identical rooms', () => __awaiter(void 0, void 0, void 0, function* () {
        const rent_to = undefined;
        const room = yield entity_1.Room.generateRoom({
            apartment_id: 1,
            facade_id: 1,
        ...
        const rooms = [room];
        const res = offer_1.pickNonIdenticalRooms(rooms);
        expect(res.length).toBe(1);
    }));
    it('should pick non identical rooms', () => __awaiter(void 0, void 0, void 0, function* () {
        const room_1 = yield entity_1.Room.generateRoom({
            apartment_id: 1,
            facade_id: 1,
            address_id: 1,
            name: 'Room',
        ...
        const room_2 = yield entity_1.Room.generateRoom({
            apartment_id: 1,
            facade_id: 1,
            address_id: 1,
            name: 'Room',
    ...
    it('should pick non identical rooms', () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        const room_3 = yield entity_1.Room.generateRoom({
            apartment_id: 1,
            facade_id: 1,
            address_id: 1,
            name: 'Room',
...
describe('testing function pickRoomsByScore()', () => {
    it('should return proper data', () => __awaiter(void 0, void 0, void 0, function* () {
        const room_1 = yield entity_1.Room.generateRoom({
            apartment_id: 1,
            facade_id: 1,
            address_id: 1,
        ...
        const rooms = [room_1, room_2, room_3];
        const userScore = yield entity_1.UserScore.generateUserScore({
            iduser: '4',
            agreeableness: 1,
            conscientiousness: 1,
        ...
        const tenantScore_1 = yield entity_1.UserScore.generateUserScore({
            iduser: '1',
            agreeableness: 1,
            conscientiousness: 1,
            emotional_stability: 1,
        ...
        const tenantScore_2 = yield entity_1.UserScore.generateUserScore({
            iduser: '2',
            agreeableness: 6,
            conscientiousness: 6,
        ...
        const tenants = [
            Object.assign(Object.assign({}, tenantScore_1), { apartment_id: 1, room_id: 1 }),
            Object.assign(Object.assign({}, tenantScore_2), { apartment_id: 1, room_id: 2 })
        ];
        const result = offer_1.pickRoomsByScore(rooms)(userScore, tenants);
        expect(result[0].facade_id).toBe(1);
        expect(result[0].score).toBe(5);
    }));
    it('should return 0 as score with generator', () => __awaiter(void 0, void 0, void 0, function* () {
        const room_1 = yield entity_1.Room.generateRoom({
            apartment_id: 1,
            facade_id: 1,
            address_id: 1,
    ...
    it('should return 10 as score with generator', () => __awaiter(void 0, void 0, void 0, function* () {
        const room_1 = yield entity_1.Room.generateRoom({
            apartment_id: 1,
            facade_id: 1,
            address_id: 1,
    ...
    it('should return 4 as score with generator', () => __awaiter(void 0, void 0, void 0, function* () {
        const room_1 = yield entity_1.Room.generateRoom({
            apartment_id: 1,
            facade_id: 1,
            address_id: 1,
...
describe('testing the offer function aggregateRawUserScore', () => {
    it('should give the structured userScore', () => __awaiter(void 0, void 0, void 0, function* () {
        const data = [
            {
                type: 'boolean',
                boolean: true,
        ...
        const result = offer_1.aggregateRawUserScore(data);

...
exports.UpdateLabelValidator = exports.CreateLabelValidator = void 0;
const inversify_1 = require("inversify");
const inversify_express_utils_1 = require("inversify-express-utils");
const joi_1 = require("joi");
let CreateLabelValidator = class CreateLabelValidator extends inversify_express_utils_1.BaseMiddleware {
...
CreateLabelValidator = __decorate([
    inversify_1.injectable()
], CreateLabelValidator);
exports.CreateLabelValidator = CreateLabelValidator;
let UpdateLabelValidator = class UpdateLabelValidator extends inversify_express_utils_1.BaseMiddleware {
    handler(req, res, next) {
        const data = req.body;
        const schema = joi_1.object().keys({
...
UpdateLabelValidator = __decorate([
    inversify_1.injectable()

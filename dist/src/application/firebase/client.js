...
exports.uploadLogo = (clientId, img) => new Promise((resolve, reject) => {
    ...
    const downloadURL = `${constants_1.FB_STORAGE_URL_PREFIX}${BUCKET_NAME}/o/logos%2F${clientId}_${currentTimestamp}.jpg?alt=media&token=${uuidToken}`;

...
exports.uploadImage = (uploaderId, img) => new Promise((resolve, reject) => {
    ...
    const downloadURL = `${constants_1.FB_STORAGE_URL_PREFIX}${FB_BUCKET_NAME}/o/incidents%2F${uploaderId}_${currentTimestamp}.jpg?alt=media&token=${uuidToken}`;
...
exports.deleteImage = (filePath) => new Promise((resolve, reject) => {
    const file = community_1.firebaseCommunityService.storage().bucket().file(`/incidents/${filePath}`);
    file.delete()
